...
function test {
    ...
    export DISPLAY=:0
    ./com.github.christophernugent.boulder --run-tests
    result=$?
...
"generate-i18n")
    initialize
    ninja com.github.christophernugent.boulder-pot
    ninja com.github.christophernugent.boulder-update-po
    ;;
"install")
    initialize
    sudo ninja install
...
"run")
    initialize
    ./com.github.christophernugent.boulder "${@:2}"
    ;;
"test")
    test
    ;;
